...
class NotchSVRParameter:
    def __init__(self):
        ...
        self.min_cross_validation_score = 1000000
            ...
            while gamma <= gamma_max:
                ...
                while epsilon <= epsilon_max:
                    ...
                    while tol <= tol_max:
                        ...
                        score_arr = cross_val_score(model, x_data_training, y_data_training, cv=cv)
                        score_avg = self.average(score_arr)
                        ...
                        if score_avg < self.min_cross_validation_score and self.model_mae[mae_name] < self.min_svr_mae:
                            self.min_cross_validation_score = score_avg
