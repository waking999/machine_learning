...
"""
use fm1, fm2 as x, search svr parameter value, not-parallel, plot with parameter values
"""
...
class Notch10a:
    def __init__(self):
        ...
        self.models = [
            SVR(C=656.8408355712888, cache_size=200, degree=3, epsilon=5.21509050846563e-06,
                gamma=85222.6929923929, kernel='rbf', max_iter=-1, shrinking=True, tol=1.7600945796607147e-05,
                verbose=False),
    ...
    def fit_plot(self, model_seq, x_data_training, y_data_training, x_data_test, y_data_test, base_k, base_b):
        ...
        for i in range(x_data_test_size):
            plt.scatter(x_data_test[i], y_data_test[i, 0], marker='.', color=self.training_set_plot_color[i])
