...
class Noch4:
    def __init__(self):
        ...
        self.models = [
            SVR(C=37876.75244106352, cache_size=200, degree=3, epsilon=0.002283658260521167,
                gamma=0.03766670616338622, kernel='rbf', max_iter=-1, shrinking=True, tol=0.002283658260521167, verbose=False),
            # SVR(C=0.6666666666666666, cache_size=200, degree=3, epsilon=0.6666666666666666,
            #     gamma=0.05852766346593506, kernel='rbf', max_iter=-1, shrinking=True, tol=0.1975308641975308,
            #     verbose=False),
    ...
    def fit_plot(self, model_seq, x_data_training, y_data_training, x_data_test, y_data_test, base_k, base_b):
        ...
        for i in range(x_data_test_size):
            ...
            print(str(x_data_test[i, 1]) + ',' + str(y_data_predict[i]))
    ...
    def calcul_corrected_mae_random(self, x_data_training_mae, y_data_training_mae, loop_num, base_k, base_b,
        ...
        for i in range(loop_num):
            y_data_expect = base_k * x_data_training_mae[i, :, 1] + base_b
    ...
    def box_plot(self, model_seq, x_data_training, y_data_training, base_k, base_b):
        ...
        for i in range(self.set_size):
            ...
            for j in range(self.num_training_set):
                ...
                # y_data_test_tmp = self.sc.inverse_transform(y_data_test_tmp)
